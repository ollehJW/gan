...
parser.add_argument("--data_dir", type=str, default='./data/original_images', help="Data directory")
...
files = glob.glob(opt.data_dir + '/*.jpg')
image_dataset_generator = dataset_generator(files, opt.batch_size)
